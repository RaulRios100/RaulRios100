      ...
      <section className="relative min-h-[60vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
            Somos <span className="text-green-600">LiberaCréditoDeTuCasa</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                LiberaCréditoDeTuCasa es la empresa que se la juega por los mexicanos atrapados con casas que son más
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                resolver los problemas más complejos relacionados con deudas hipotecarias y propiedades abandonadas.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6 pt-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">Hipotecas con deudas hipotecarias</div>
                </div>
              </div>
            </div>
            ...
            {[
              {
                ...
                desc: "Pago o reestructuración de deudas de servicios (agua, luz, predial) o deudas hipotecarias.",
                color: "green",
              },
              {
                icon: Home,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  "Deudas hipotecarias o servicios públicos que afectan el buró de crédito",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            <Card className="text-center border-2 border-green-500/20 hover:border-green-500/50 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  ¡Sacarte del hoyo! LiberaCréditoDeTuCasa existe para liberar a los mexicanos de deudas y casas que los
            ...
            <Card className="text-center border-2 border-orange-500/20 hover:border-orange-500/50 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Ser los chidos que cambian el juego en México, liberando casas y sueños, y convirtiendo problemas en
              ...
              <CardContent>
                <div className="text-left space-y-3">
                  ...
                  <div>
                    ...
                    <span className="text-muted-foreground"> Liberamos casas para mejorar barrios.</span>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Maestros en Deudas Hipotecarias",
                desc: "Conocemos cada detalle de las deudas hipotecarias, que manejan gran parte de las hipotecas en México.",
                icon: "🎯",
              },
              {
                title: "Todo en uno",
                desc: "Pagamos deudas, arreglamos papeles, liberamos casas y te damos efectivo para cerrar el capítulo.",
                icon: "🔧",
              },
              {
                title: "Zonas clave",
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
            En LiberaCréditoDeTuCasa, tu casa no es un problema, ¡es nuestra misión! Déjanos pelear por ti y convierte
            ese dolor de cabeza en un nuevo capítulo.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button
              size="lg"
              className="bg-white text-green-600 hover:bg-gray-100 px-8 py-4 text-lg group"
              onClick={() => {
                const message = encodeURIComponent(
                  "¡Hola! Leí sobre su empresa y me interesa conocer más sobre sus servicios de liberación de vivienda. ¿Pueden ayudarme?",
                )
      ...
      <footer className="bg-background border-t border-border py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground">
            <p>&copy; 2024 LiberaCréditoDeTuCasa. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
      <FloatingContact />
