...
import { ArrowLeft, Scale, AlertTriangle, FileText, XCircle, CheckCircle, Clock, DollarSign } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Al utilizar los servicios de LiberaCréditoDeTuCasa, aceptas estos términos y condiciones en su
                    totalidad. Si no estás de acuerdo con alguna parte, te recomendamos no utilizar nuestros servicios.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold mb-2 text-green-600">LiberaCréditoDeTuCasa</h4>
                    <p className="text-sm text-muted-foreground">
                      Empresa especializada en la adquisición, liquidación y liberación de propiedades con deudas
                      hipotecarias.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Persona física propietaria de un inmueble que solicita nuestros servicios de liberación.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2 text-green-600">Propiedad/Inmueble</h4>
                    <p className="text-sm text-muted-foreground">
                      Casa, departamento o terreno adquirido mediante crédito con deudas hipotecarias objeto del
                      servicio.
                    </p>
                  </div>
                  <div>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      • <strong>Liquidación de Deudas:</strong> Pago total de deudas hipotecarias y servicios
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground ml-4">
                    <li>• Asesoría legal especializada en deudas hipotecarias</li>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>• Estado de cuenta de deudas hipotecarias actualizado</li>
            ...
            {/* Obligaciones de LiberaCréditoDeTuCasa */}
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-xl">
                  <CheckCircle className="h-6 w-6 mr-3 text-green-600" />
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      • <strong>Gastos Notariales:</strong> Cubiertos por LiberaCréditoDeTuCasa
                    </li>
                    <li>
                      • <strong>Trámites Legales:</strong> Incluidos en el servicio sin costo adicional
                    </li>
                    <li>
                      • <strong>Liquidación de Deudas:</strong> Pagamos directamente a instituciones de crédito
                      hipotecario y servicios
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>• Deducción de todas las deudas pendientes (deudas hipotecarias, servicios, predial)</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold mb-3 text-green-600">Terminación por LiberaCréditoDeTuCasa</h4>
                  <ul className="space-y-2 text-muted-foreground ml-4">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  LiberaCréditoDeTuCasa se reserva el derecho de modificar estos términos y condiciones en cualquier
                  momento. Las modificaciones entrarán en vigor inmediatamente después de su publicación en nuestro
                  sitio web.
                </p>
                <p className="text-muted-foreground">
            ...
            <Card className="border-2 border-green-500/20 bg-green-50 dark:bg-green-950/20">
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-green-700 dark:text-green-300">
                  <p>
                    <strong>LiberaCréditoDeTuCasa</strong>
                  </p>
